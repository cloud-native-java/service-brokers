...
/**
 * See: http://docs.cloudfoundry.com/docs/running/
...
public class ServiceInstanceController extends BaseController {
	...
	public ResponseEntity<ServiceInstanceStateResponse> getLastServiceInstanceOperation(
			@PathVariable("instanceId") String serviceInstanceId)
			throws ServiceDefinitionDoesNotExistException, ServiceInstanceExistsException,
			ServiceBrokerException, ServiceInstanceDoesNotExistException {

		logger
				.debug("GET: "
						+ BASE_PATH
						+ "/{instanceId}/last_operation, getLastServiceInstanceOperation(), serviceInstanceId = "
						+ serviceInstanceId);
		...
		return new ResponseEntity<>(new ServiceInstanceStateResponse("succeeded",
				"Service created"), HttpStatus.OK);
	}
	...
	public ResponseEntity<ServiceInstance> getServiceInstance(
		...
		logger
				.debug("GET: " + BASE_PATH
						+ "/{instanceId}, getServiceInstance(), serviceInstanceId = "
						+ serviceInstanceId);
		ServiceInstance instance = service.getServiceInstance(serviceInstanceId);
	...
	public ResponseEntity<CreateServiceInstanceResponse> createServiceInstance(
		...
		ServiceInstance instance = service.createServiceInstance(request
				.withServiceDefinition(svc).and().withServiceInstanceId(serviceInstanceId));
	...
	public ResponseEntity<?> deleteServiceInstance(
		...
		ServiceInstance instance = service
				.deleteServiceInstance(new DeleteServiceInstanceRequest(instanceId, serviceId,
						planId));
		if (instance == null) {
	...
	public ResponseEntity<?> updateServiceInstance(
			...
			ServiceInstanceDoesNotExistException, ServiceBrokerException {
		logger.debug("UPDATE: " + BASE_PATH + "/{instanceId}"
				+ ", updateServiceInstanceBinding(), serviceInstanceId = " + instanceId
				+ ", instanceId = " + instanceId + ", planId = " + request.getPlanId());
		ServiceInstance instance = service.updateServiceInstance(request
	...
	public ResponseEntity<ErrorMessage> handleException(
			ServiceDefinitionDoesNotExistException ex, HttpServletResponse response) {
	...
	@ResponseBody
	public ResponseEntity<ErrorMessage> handleException(
			ServiceInstanceUpdateNotSupportedException ex, HttpServletResponse response) {
		return getErrorResponse(ex.getMessage(), HttpStatus.UNPROCESSABLE_ENTITY);
	}
