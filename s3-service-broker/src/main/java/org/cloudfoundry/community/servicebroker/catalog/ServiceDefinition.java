...
public class ServiceDefinition implements Serializable {
 ...
 public ServiceDefinition(String name, String description, boolean bindable,
 ...
 public ServiceDefinition(String id, String name, String description, boolean bindable,
   Collection<Plan> plans, Map<String, Object> metadata) {
 ...
 public boolean equals(Object o) {
  ...
  if (bindable != that.bindable)
   return false;
  if (planUpdateable != that.planUpdateable)
   return false;
  ...
  if (metadata != null ? !metadata.equals(that.metadata) : that.metadata != null)
   return false;
  if (requires != null ? !requires.equals(that.requires) : that.requires != null)
   return false;
  return !(dashboardClient != null ? !dashboardClient.equals(that.dashboardClient)
    : that.dashboardClient != null);
 ...
 public String toString() {
  return "ServiceDefinition{" + "id='" + id + '\'' + ", name='" + name + '\''
    ...
    + ", planUpdateable=" + planUpdateable + ", plans=" + plans + ", tags=" + tags
    + ", metadata=" + metadata + ", requires=" + requires + ", dashboardClient="
    + dashboardClient + '}';
 }
}
