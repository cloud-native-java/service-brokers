...
/**
 * Thrown when a duplicate service instance
...
public class ServiceInstanceExistsException extends Exception {
 ...
 public ServiceInstanceExistsException(ServiceInstance instance) {
  super("ServiceInstance with the given ID already exists: " + "ServiceInstance.id = "
    + instance.getServiceInstanceId() + ", Service.id = "
