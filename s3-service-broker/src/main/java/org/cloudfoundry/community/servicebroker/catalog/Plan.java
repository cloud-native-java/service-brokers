...
/**
 * A service plan available for a
 * ServiceDefinition
 *
...
public class Plan {
	...
	public boolean equals(Object o) {
		...
		if (name != null ? !name.equals(plan.name) : plan.name != null)
			return false;
		if (description != null ? !description.equals(plan.description)
	...
	public String toString() {
		return "Plan{" + "id='" + id + '\'' + ", name='" + name + '\'' + ", description='"
				+ description + '\'' + ", metadata=" + metadata + ", free=" + free + '}';
	}
