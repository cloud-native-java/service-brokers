...
public class ServiceInstance {
 ...
 /**
  * Create a ServiceInstance from a create
  * request. If fields are not present in the
  * request they will remain null in the
  * ServiceInstance.
  *
  * @param request containing details of
  * ServiceInstance
  */
 ...
 /**
  * Create a ServiceInstance from a delete
  * request. If fields are not present in the
  * request they will remain null in the
  * ServiceInstance.
  *
 ...
 /**
  * Create a service instance from a delete
  * request. If fields are not present in the
  * request they will remain null in the
  * ServiceInstance.
  *
