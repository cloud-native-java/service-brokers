...
public class ServiceInstanceBindingFixture {
 ...
 public static ServiceInstanceBinding getServiceInstanceBinding() {
  ...
  return new ServiceInstanceBinding(getServiceInstanceBindingId(),
    instance.getServiceInstanceId(), getCredentials(), getSysLogDrainUrl(),
    getAppGuid());
 }
 ...
 public static CreateServiceInstanceBindingRequest getServiceInstanceBindingRequest() {
  return new CreateServiceInstanceBindingRequest(ServiceFixture.getService().getId(),
    PlanFixture.getPlanOne().getId(), getAppGuid(), ParametersFixture.getParameters());
 }
