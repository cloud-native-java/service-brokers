...
public class AmazonProperties {
	 ...
	 * configurations
	 *
	 * @return a property group for AWS
	 * configurations
	 */
	public Aws getAws() {
		return aws;
	 ...
	 * configurations
	 *
	 * @param aws is a property group for AWS
	 * configurations
	 */
	 ...
	 *
	 * @return a property group for Amazon S3
	 * configurations
	 */
	public S3 getS3() {
		return s3;
	 ...
	 * A property group for Amazon S3 configurations
	 *
	 * @param s3 is a property group for Amazon S3
	 * configurations
	 */
	...
	public static class Aws {
		 ...
		 * A valid AWS account's access key id.
		 *
		 * @param accessKeyId is a valid AWS account's
		 * access key id.
		 */
		 ...
		 * A valid AWS account's secret access token.
		 *
		 * @param accessKeySecret is a valid AWS
		 * account's secret access token.
		 */
		...
		public String toString() {
			return "Aws{" + "accessKeyId='" + accessKeyId + '\'' + ", accessKeySecret='"
					+ accessKeySecret + '\'' + '}';
		}
	}
